    ...
    <div className="mx-auto max-w-5xl space-y-6 px-4 py-10">
      <header className="space-y-2">
        ...
        <nav className="inline-flex gap-2 rounded-full bg-slate-100 p-1 shadow-sm" aria-label="Views">
          <Link to="/" className="rounded-full px-4 py-2 font-semibold text-sm transition [&.active]:bg-white [&.active]:text-[#202235] [&.active]:shadow text-slate-600">
            Overview
          </Link>
          <Link to="/books" className="rounded-full px-4 py-2 font-semibold text-sm transition [&.active]:bg-white [&.active]:text-[#202235] [&.active]:shadow text-slate-600">
            Books
          </Link>
        </nav>
      </header>
