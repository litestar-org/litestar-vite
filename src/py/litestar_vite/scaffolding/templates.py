...
class FrameworkType(str, Enum):
    ...
    REACT_INERTIA_JINJA = "react-inertia-jinja"
    VUE = "vue"
    VUE_INERTIA = "vue-inertia"
    VUE_INERTIA_SSR = "vue-inertia-ssr"
    VUE_INERTIA_JINJA = "vue-inertia-jinja"
    VUE_INERTIA_JINJA_SSR = "vue-inertia-jinja-ssr"
    SVELTE = "svelte"
    SVELTE_INERTIA = "svelte-inertia"
    SVELTE_INERTIA_JINJA = "svelte-inertia-jinja"
    SVELTEKIT = "sveltekit"
    NUXT = "nuxt"
    ASTRO = "astro"
    HTMX = "htmx"
    JINJA_HTMX = "jinja-htmx"
    HTMX_NO_JINJA = "htmx-no-jinja"
    ANGULAR = "angular"
...
FRAMEWORK_TEMPLATES: dict[FrameworkType, FrameworkTemplate] = {
    ...
    FrameworkType.REACT_INERTIA_JINJA: FrameworkTemplate(
        name="React + Inertia.js (Jinja shell)",
        type=FrameworkType.REACT_INERTIA_JINJA,
        description="React with Inertia.js rendered into a Jinja2 page shell (template mode)",
        vite_plugin="@vitejs/plugin-react",
        dependencies=["react", "react-dom", "@inertiajs/react"],
        dev_dependencies=["@vitejs/plugin-react", "@types/react", "@types/react-dom", "typescript", "vite"],
        files=[
    ...
    FrameworkType.VUE_INERTIA_SSR: FrameworkTemplate(
        name="Vue + Inertia.js (SSR)",
        type=FrameworkType.VUE_INERTIA_SSR,
        description="Vue with Inertia.js server-side rendering (Node /render runner on port 13714)",
        vite_plugin="@vitejs/plugin-vue",
        dependencies=["vue", "@inertiajs/vue3", "@vue/server-renderer"],
        dev_dependencies=["@vitejs/plugin-vue", "vue-tsc", "typescript"],
        files=[
            "vite.config.ts",
            "tsconfig.json",
    ...
    FrameworkType.VUE_INERTIA_JINJA: FrameworkTemplate(
        name="Vue + Inertia.js (Jinja shell)",
        type=FrameworkType.VUE_INERTIA_JINJA,
        description="Vue with Inertia.js rendered into a Jinja2 page shell (template mode)",
        vite_plugin="@vitejs/plugin-vue",
        dependencies=["vue", "@inertiajs/vue3"],
        dev_dependencies=["@vitejs/plugin-vue", "vue-tsc", "typescript"],
        files=[
    ...
    FrameworkType.VUE_INERTIA_JINJA_SSR: FrameworkTemplate(
        name="Vue + Inertia.js + Jinja shell (SSR)",
        type=FrameworkType.VUE_INERTIA_JINJA_SSR,
        description="Vue + Inertia + Jinja2 shell with SSR (template mode, target_selector=#app)",
        vite_plugin="@vitejs/plugin-vue",
        dependencies=["vue", "@inertiajs/vue3", "@vue/server-renderer"],
        dev_dependencies=["@vitejs/plugin-vue", "vue-tsc", "typescript"],
        files=[
    ...
    FrameworkType.SVELTE_INERTIA_JINJA: FrameworkTemplate(
        name="Svelte + Inertia.js (Jinja shell)",
        type=FrameworkType.SVELTE_INERTIA_JINJA,
        description="Svelte 5 with Inertia.js rendered into a Jinja2 page shell (template mode)",
        vite_plugin="@sveltejs/vite-plugin-svelte",
        dependencies=["svelte", "@inertiajs/svelte"],
        dev_dependencies=["@sveltejs/vite-plugin-svelte", "svelte-check", "typescript", "tslib"],
        files=[
    ...
    FrameworkType.JINJA_HTMX: FrameworkTemplate(
        name="HTMX (Jinja shell)",
        type=FrameworkType.JINJA_HTMX,
        description="Server-rendered HTML with HTMX and a Jinja2 page shell",
        vite_plugin=None,
        dependencies=["htmx.org"],
        dev_dependencies=["typescript"],
        files=[
    ...
    FrameworkType.HTMX_NO_JINJA: FrameworkTemplate(
        name="HTMX (no Jinja)",
        type=FrameworkType.HTMX_NO_JINJA,
        description="HTMX in template mode without a TemplateConfig — handlers return raw HTML strings",
        vite_plugin=None,
        dependencies=["htmx.org"],
        dev_dependencies=["typescript"],
        files=["package.json", "vite.config.ts", "tsconfig.json", "index.html", "resources/main.js"],
        uses_typescript=False,
        has_ssr=False,
        inertia_compatible=False,
        resource_dir="resources",
